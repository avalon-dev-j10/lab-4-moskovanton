...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*  TODO (Замечание№1 ЛР№4)
            - В условии "Сторки, расположенные не по порядку" имелось ввиду, что
            строки в массиве должны быть не упорядочены и с помощью сортировки ты
            бы их смог отсортировать!
        */
	 ...
	 *
        ...
        persons[0] = new Human("Phil", "Johns", new Date(1999,11,22));
        persons[1] = new Human("Phil", "Johns", new Date(1988,01,11));
         ...
         */
         ...
         /*  TODO (Замечание№1 ЛР№4)
            - В условии сказано проверить выполнение с помощью отладчика, попробуй это
            сделать, ставишь несколько точек остановки и смотришь состояние массивов
